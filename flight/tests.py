...
class FlightListTest(TestCase):
    ...
    def test_flight_get_success(self):
        response = self.client.get('/flight?departure=GMP&arrival=CJU&date=2021-03-12&sort=departureTime:asc&timeOption=1&timeOption=2&timeOption=3&timeOption=4', content_type = 'application/json')
    ...
    def test_flight_sorting_success(self):
        response = self.client.get('/flight?departure=GMP&arrival=CJU&date=2021-03-12&sort=price:asc&timeOption=1&timeOption=2&timeOption=3&timeOption=4', content_type = 'application/json')
    ...
    def test_flight_time_filtering_success(self):
        response = self.client.get('/flight?departure=GMP&arrival=CJU&date=2021-03-12&sort=departureTime:asc&timeOption=1', content_type = 'application/json')
    ...
    def test_flight_value_error(self):
        response = self.client.get('/flight?departure=GMP&arrival=CJU&date=2021-03-12&sort=price:asc&timeOption=dk')
    ...
    def test_flight_idnex_error(self):
        response = self.client.get('/flight?timeOption=3&timeOption=4&departure=CJU&arrival=GMP&date=2021-03-12&sort=departureTime:desc', content_type = 'application/json')
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.json(), {
            'message'             : 'INDEX_ERROR',
            'date'                : '2021-03-12',
